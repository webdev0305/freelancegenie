    ...
    $.fn.formToWizard = function (options, cmdParam1) {
        ...
        function createPrevButton(i) {
            ...
            $('#' + stepName + 'commands').append(
                '<' + options.buttonTag + ' href="#mtform" id="' + stepName + 'Prev" class="' + options.prevBtnClass + '">' +
                options.prevBtnName +
                '</' + options.buttonTag + '>'
            );
        ...
        function createNextButton(i) {
            var stepName = 'step' + i;
            $('#' + stepName + 'commands').append(
                '<' + options.buttonTag + ' href="#mtform" id="' + stepName + 'Next" class="' + options.nextBtnClass + '">' +
                options.nextBtnName +
                '</' + options.buttonTag + '>');
        ...
        function vlidateForms() {
			...
			jQuery.validator.addMethod('righttowork', function (value) {
                return (value == "1");
            }, "You must have right to work in UK");
			jQuery.validator.addMethod('drivinglicense', function (value) {
                return (value == "1");
            }, "You must have Full UK Driving License");
			jQuery.validator.addMethod('dbscert', function (value) {
                return (value == "1");
            }, "You must have a valid DBS Certificate");
			jQuery.validator.addMethod('dbsupdate', function (value) {
                return (value == "1");
            }, "You must be registered for the DBS update service");
            ...
            form.validate({
                ...
                rules: {
					...
					pass_start_date: {
					required: "#rtowork1:checked"
					},
					pass_expiry_date: {
					required: "#indifinite_st:unchecked"
					},
					passport_no: {
					required: "#rtowork1:checked"
					},
					permit_start_date: {
					required: "#rtowork2:checked"
					},
					permit_expiry_date: {
					required: "#rtowork2:checked"
					},
                ...
                messages: {
					...
					rtowork: {
                        required: "Please choose the one you have",
					},
					pass_start_date: {
					required: "Please enter passport start date"
					},
					pass_expiry_date: {
					...
					permit_start_date: {
					required: "Please enter work permit start date"
					},
					permit_expiry_date: {
					required: "Please enter work permit expiry date"
					},
					permit_no: {
					required: "Please enter work permit no."
					},
