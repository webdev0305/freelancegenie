        ...
        <div class="text-wrap mb2">
            ...
            <form class="form-hrizontal" method="POST" action="{{ url('admin/privacy') }}">
                ...
                <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                    ...
                    <input id="title" type="text" maxlength="255" class="form-control" name="title" value="{{ $freelancer->title }}" required
                           autofocus>
                    @if ($errors->has('title'))
                ...
                <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                    ...
                    <textarea name="description"  class="form-control"  id="description">{{ $freelancer->description }}</textarea>
