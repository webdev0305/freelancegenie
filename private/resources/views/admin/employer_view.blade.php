...
<div class="view-page">
        ...
        <section class="plan_details_employer">
            ...
            <div class="inner_plan_details">
                ...
                <p><strong>Subscription Expires On:</strong>
                    {{$subs_end=date('d/m/Y', strtotime(' + '.$subs->plan->duration, strtotime($subs->updated_at)))}}
                </p>
                ...
                <p><strong>Assignment Posts:</strong>
                    {{isset($SubscriptionLimit->assignment)?($SubscriptionLimit->assignment):$subs->plan->post_assignment}}
                    out of {{$subs->plan->post_assignment}}</p>
            </div>
        </section>
    ...
    <div class="text-wrap  mb2">
        <div class="img-wrap text-center"> <img class="img-responsive"
                src="{{asset('images/company_logo/'.$usersMeta->employer_profile->company_logo)}}"></div>
        <div class="heading">
    ...
    <div class="text-wrap  mb2">
        ...
        <div class="row mb1">
            ...
            <div class="col-sm-6">
                <div class="out-wrap">
                    <p><strong>Do any of the Audience have any learning difficulties or disabilities that we need to be
                            aware of?</strong>
        ...
        <div class="row mb1">
            <div class="col-sm-6">
                <div class="out-wrap">
                    <p><strong>Is there any equipment available onsite to be used? , if not, please tell us what you
                            would like provided?</strong>
                        <span>{{$usersMeta->employer_profile->equipment_available_onsite == '1' ? 'YES' : 'NO'}}</span>
                    </p>
                </div>
            </div>
            <div class="col-sm-6">
    ...
    <div class="text-wrap  mb2">
        ...
        <div class="row mb1">
            <div class="col-sm-6">
                <div class="out-wrap">
                    <a href="{{ url('employer_makepdf') }}/{{$usersMeta->employer_profile->user_id}}" class="btn btn-square btn-option3 btn-icon wdth red_btn"><i class="fa fa-download" aria-hidden="true"></i> Download</a>
                </div>
            </div>
        </div>
    </div>
