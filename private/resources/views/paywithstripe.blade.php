	...
	<div class="container">
		...
		<div class="form-wrap">
				...
				<form class="form-horizontal" method="POST" id="payment-form" role="form"
					...
					<div class='form-row'>
						<div class='col-12 col-md-4 form-group cvc required'>
							...
							<input autocomplete='off' required value="314" class='form-control card-cvc' maxlength="3"
								minlength="3" placeholder='ex. 311' size='6' type='number' name="cvvNumber">
						</div>
						<div class='col-6 col-md-4 form-group expiration required'>
							<label class='control-label'>Expiration (Month)</label>
							<input class='form-control card-expiry-month' value="10" required placeholder='MM' size='2'
								type='text' name="ccExpiryMonth">
						</div>
						<div class='col-6 col-md-4 form-group expiration required'>
							<label class='control-label'>(Year)</label>
							<input class='form-control card-expiry-year' value="2020" required placeholder='YYYY'
								size='4' type='text' name="ccExpiryYear">
					...
					<div class='form-row'>
						<div class='col-md-12'>
							<button class='form-control w-100 text-center btn btn-primary submit-button'
			...
			<div id="onaccount_form" style="display:none;">
				<form class="form-horizontal" method="POST" id="payment-form" role="form"
					action="{!!route('addmoney.onaccount')!!}">
					{{ csrf_field() }}

					<div class='form-row'>
						<div class='col-md-12'>
							<input required type='hidden' value="{{Request::segment(2)}}" name="user_id">
							<p>Admin will verify your profile and request. Once approved you will receive an email
								within 24-48hrs where you can gain access using the Username and Password you entered
