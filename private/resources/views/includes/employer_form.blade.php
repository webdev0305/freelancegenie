	...
	<div class="row">
		<div class="col-md-6 col-sm-6">
			<div class="form-group ">
				...
				<input class="form-control" id="company_name" value="{{$usersMeta->employer_profile->company_name}}"
		...
		<div class="col-md-6 col-sm-6">
			<div class="form-group ">
				...
				<input class="form-control" id="company_address"
					value="{{$usersMeta->employer_profile->company_address}}" name="company_address" type="text" />
			</div>
		</div>
	</div>
		...
		<div class="col-md-6 col-sm-6">
			<div class="form-group ">
				...
				<input class="form-control" id="comp_street_name"
					value="{{$usersMeta->employer_profile->comp_street_name}}" name="comp_street_name" type="text" />
			</div>
		</div>
		<!--<div class="col-md-6 col-sm-6">
	<div class="form-group ">
				...
				<select class="form-control" name="comp_country" id="comp_country">
					...
					<optgroup label="{{$country->name}}" data-max-options="1">
						...
						<option value="{{$categorieChild->id}}"
							{{ !empty($usersMeta->employer_profile->comp_country_id) ? $categorieChild->id ==$usersMeta->employer_profile->comp_country_id   ? 'selected="selected"' : '' : ''}}>
	...
	<div class="row">
		...
		<div class="col-md-6 col-sm-6">
			<div class="form-group ">
				...
				<input class="form-control" id="comp_postcode" value="{{$usersMeta->employer_profile->comp_postcode}}"
	...
	<div class="row">
		<div class="col-md-6 col-sm-6">
			<div class="form-group ">
				...
				<input class="form-control" id="contact_tel" value="{{$usersMeta->employer_profile->contact_tel}}"
		...
		<div class="col-md-6 col-sm-6">
			<div class="form-group ">
				...
				<input class="form-control" id="comp_email" value="{{$usersMeta->employer_profile->comp_email}}"
		...
		<div class="col-md-6 col-sm-6">
			<div class="form-group ">
				...
				<input class="form-control" id="head_office_address"
					value="{{$usersMeta->employer_profile->head_office_address}}" name="head_office_address"
					type="text" />
		...
		<div class="col-md-6 col-sm-6">
			<div class="form-group ">
				...
				<input class="form-control" id="head_office_street_name"
					value="{{$usersMeta->employer_profile->head_office_street_name}}" name="head_office_street_name"
					type="text" />
			</div>
		</div>
	</div>
			...
			<div class="form-group ">
				...
				<select class="form-control" name="head_office_country" id="head_office_country">
					...
					<optgroup label="{{$country->name}}" data-max-options="1">
						...
						<option value="{{$categorieChild->id}}"
							{{ !empty($usersMeta->employer_profile->head_office_country_id) ? $categorieChild->id ==$usersMeta->employer_profile->head_office_country_id   ? 'selected="selected"' : '' : ''}}>
							{{$categorieChild->name}}</option>
		...
		<div class="col-md-6 col-sm-6">
			<div class="form-group ">
				...
				<input class="form-control" id="head_office_postcode"
					value="{{$usersMeta->employer_profile->head_office_postcode}}" name="head_office_postcode"
					type="text" />
			</div>
		</div>
		<div class="col-md-6 col-sm-6">
	...
	<div class="row">
		<div class="col-md-6 col-sm-6">
			<div class="form-group ">
				...
				<input class="form-control" id="dept" value="{{$usersMeta->employer_profile->dept}}" name="dept"
					type="text" />
				@if ($errors->has('dept'))
				<span class="help-block">
		...
		<div class="col-md-6 col-sm-6">
			<div class="form-group ">
				...
				<input class="form-control" id="head_o_no" value="{{$usersMeta->employer_profile->head_o_no}}"
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			<div class="form-group ">
				...
				<input class="form-control" id="head_o_email" value="{{$usersMeta->employer_profile->head_o_email}}"
		...
		<div class="col-md-6 col-sm-6">
			<div class="form-group ">
				...
				<input class="form-control" id="authorised_user"
					value="{{$usersMeta->employer_profile->authorised_user}}" name="authorised_user" type="text" />
			...
			<div class="form-group ">
				...
				<input class="form-control" id="email" value="{{$usersMeta->employer_profile->email}}" name="email"
					type="text" />
				@if ($errors->has('email'))
				<span class="help-block">
			...
			<div class="form-group ">
				...
				<input class="form-control" id="dd_tel" value="{{$usersMeta->employer_profile->dd_tel}}" name="dd_tel"
					type="text" />
			...
			<div class="form-group ">
				...
				<input class="form-control" id="contact_no" value="{{$usersMeta->employer_profile->contact_no}}"
		...
		<div class="col-md-6 col-sm-6">
			<div class="form-group ">
				...
				<input class="form-control" id="authorised_user_second"
					value="{{$usersMeta->employer_profile->authorised_user_second}}" name="authorised_user_second"
					type="text" />
			...
			<div class="form-group ">
				...
				<input class="form-control" id="email_second" value="{{$usersMeta->employer_profile->email_second}}"
			...
			<div class="form-group ">
				...
				<input class="form-control" id="dd_tel2" value="{{$usersMeta->employer_profile->dd_tel2}}"
			...
			<div class="form-group ">
				...
				<input class="form-control" id="contact_no_second"
					value="{{$usersMeta->employer_profile->contact_no_second}}" name="contact_no_second" type="text" />
	...
	<div class="row">
		<div class="col-md-6 col-sm-6">
			<div class="form-group ">
				...
				<input class="form-control" id="company_reg_no" value="{{$usersMeta->employer_profile->company_reg_no}}"
		...
		<div class="col-md-6 col-sm-6">
			<div class="form-group ">
				...
				<input class="form-control" id="company_vat_reg_no"
					value="{{$usersMeta->employer_profile->company_vat_reg_no}}" name="company_vat_reg_no"
					type="text" />
...
-->
		...
		<div class="col-md-12 col-sm-12">
			<div class="form-group">
				...
				<a class="download_btn" download="{{$usersMeta->photo}}"
					href="{{asset('images/company_logo').'/'.$usersMeta->photo}}" title="User photo">
	...
	<div class="row">
		<div class="col-md-6 col-sm-6">
			<div class="form-group ">
				...
				<input class="form-control valid" id="amount_limit"
					value="{{$usersMeta->employer_profile->amount_limit}}" name="amount_limit" type="text">
			</div>
		</div>
		...
		<div class="col-md-6 col-sm-6">
			<div class="form-group">
				...
				<a class="download_btn" download="{{$usersMeta->order_limit}}"
					href="{{asset('images/order_limit').'/'.$usersMeta->order_limit}}" title="User Order Agreement">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			<h4 class="form_inner_titile">Terms of Service Agreement</h4>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-6 col-sm-6">
			<div class="form-group ">
				<a href="{{url('employer/service_agree')}}" class="btn btn-default prev" id="preview_contract" name="preview_contract" style="width:250px">
