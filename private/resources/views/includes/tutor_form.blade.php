...
<fieldset>
    ...
    <div class="row">
	<input type='checkbox' {{(isset($subs->plan->plan_no) && ($subs->plan->plan_no == "8" || $subs->plan->plan_no == "9")) ? 'checked' : ''}} id="plan_check" value="1" style="opacity:0; position:absolute; left:9999px;">
    ...
    <div class="row">
	   ...
	   <div class="col-md-6 col-sm-6">
			<div class="form-group ">
                ...
                <input class="form-control" id="street_name"
                       value="{{$usersMeta->tutor_profile->street_name}}"
	...
	<div class="col-md-6 col-sm-6">
		<div class="form-group ">
			...
			<input class="form-control" id="tutor_company_name"
				   value="{{$usersMeta->tutor_profile->tutor_company_name}}"
				   name="tutor_company_name" type="text"/>
	...
	<div class="col-md-6 col-sm-6">
		<div class="form-group ">
			...
			<input class="form-control" id="company_address"
				   value="{{$usersMeta->tutor_profile->company_address}}"
...
<div class="col-md-6 col-sm-6">
	...
	<input class="form-control" id="comp_street_name"
		   value="{{$usersMeta->tutor_profile->comp_street_name}}"
...
@foreach(\App\Model\Country::all() as  $country)
            @if(isset($country->children['0']))
                <optgroup label="{{$country->name}}"
                          data-max-options="1">
                    @foreach($country->children as  $categorieChild)
                        <option value="{{$categorieChild->id}}" {{ !empty($usersMeta->tutor_profile->comp_country_id) ? $categorieChild->id ==$usersMeta->tutor_profile->comp_country_id   ? 'selected="selected"' : '' : ''}}>{{$categorieChild->name}}</option>
                    @endforeach
                    @endif
                    @endforeach
                </optgroup>  
...
<div class="col-md-6 col-sm-6">
	<div class="form-group ">
		...
		<input class="form-control" id="comp_postcode"
			   value="{{$usersMeta->tutor_profile->comp_postcode}}"
...
<div class="col-md-6 col-sm-6">
	<div class="form-group ">
		...
		<input class="form-control" id="contact_tel"
			   value="{{$usersMeta->tutor_profile->contact_tel}}"
...
<div class="col-md-6 col-sm-6">
	<div class="form-group ">
		...
		<input class="form-control" id="comp_email"
			   value="{{$usersMeta->tutor_profile->comp_email}}"
	...
	<div class="col-md-6 col-sm-6">
		...
		<div class="form-group ">
			...
			<input class="form-control" id="company_reg_no"
				   ...
				   value="{{$usersMeta->tutor_profile->company_reg_no}}"
	...
	<div class="col-md-6 col-sm-6">
		...
		<div class="form-group ">
			...
			<input class="form-control" id="company_vat_reg_no"
				   ...
				   value="{{$usersMeta->tutor_profile->company_vat_reg_no}}"

				   name="company_vat_reg_no" type="number"/>
    ...
    <div class="row">
		...
		-->
				...
				<div class="form-group ">
					...
					<div class="radio">
						<label>
							<input type="radio" name="dbs_cert" id="dbs_cert2"
            ...
            <div class="form-group">
                ...
                <input class="form-control valid"
                       ...
                       id="dbs_certificate_no" name="dbs_certificate_no" type="number"
                       aria-invalid="false">
            </div>
        </div>
      </div>
    <div class="row">
          <div class="col-md-6 col-sm-6">
            <div class="form-group ">
                ...
                <div data-date-format="yyyy-mm-dd" class="input-group date date_error"
...
<div class="col-md-6 col-sm-6">
				<div class="form-group ">
					...
					<div class="radio">
						<label>
							<input type="radio" name="dbs_update" id="dbs_update2"
								   value="0" {{ $usersMeta->tutor_profile->dbs_update == '0' ?  "checked" : '' }} >No
						</label> 
						<label>
							<input type="radio" name="dbs_update" id="dbs_update"
								   value="1" {{ $usersMeta->tutor_profile->dbs_update == '1' ?  "checked" : '' }} >Yes
						</label>
					</div>
				</div> 
		</div>
		...
		<div class="col-md-6 col-sm-6">
            <div class="form-group ">
                ...
                <div data-date-format="yyyy-mm-dd" class="input-group date date_error"
                     data-provide="datepicker">
                    <input readonly type="text"
                           value="{{$usersMeta->tutor_profile->dbs_reg_update_date}}"
                           class="form-control" name="dbs_reg_update_date"
                           id="dbs_reg_update_date">
                    <div class="input-group-addon">
                        <span class="glyphicon glyphicon-th"><i class="far fa-calendar-alt"></i></span>
                    </div>
                </div>
        ...
        <div class="col-md-6 col-sm-6">
            <div class="form-group">
                ...
                <input class="form-control valid"
                       value="{{$usersMeta->tutor_profile->dbs_service_id}}"
                       id="dbs_service_id" name="dbs_service_id" type="number"
                       aria-invalid="false">
            </div>
        </div>
        <!--<div class="col-md-6 col-sm-6">
    ...
    <div class="row">
		...
		<div class="col-md-6 col-sm-6" id="condition_box" style="{{ $usersMeta->tutor_profile->medical_description == '0' ? 'display:none;' : ''}}">
            <div class="form-group">
                <label class="control-label" for="medical_description">
                    Describe the medical conditions and any disabilities
                </label>
                <input class="form-control valid"
                       value="{{$usersMeta->tutor_profile->medical_description}}"
                       id="medical_description" name="medical_description" type="text"
                       aria-invalid="false">
            </div>
        </div>
    </div>
...
<fieldset>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div id="div_disciplines_level" class="form-group">
                                            ...
                                            <div class="controls disciplines_level types_div">
												...
												<select class="form-control types length" name="disciplines_level[{{$keyCerti}}]"  id="disciplines_{{$keyCerti}}_level">
														...
														@foreach($categories as  $categorieItem)
															@if(isset($categorieItem->children['0']))
																@foreach($categorieItem->children as  $categorieChild)
																  ...
																  <option selected value="{{$categorieChild->id}}">{{$categorieChild->name}}</option>
																	@endif
																@endforeach
                                                            @endif
                                                        @endforeach
									...
									<div class="col-md-2">
                                            <div id="div_organization_registration"
                                                ...
                                                <div data-date-format="yyyy-mm-dd" class="input-group certificates_valid date date_error" data-provide="datepicker">
                                                    <input type="text" readonly
                                                           name="certificates_valid[{{$keyCerti}}]" value="{{isset($usersMeta->categories[$keyCerti]->pivot->valid) ? $usersMeta->categories[$keyCerti]->pivot->valid : ''}}" aria-invalid="false"
                                                           id="certificates_{{$keyCerti}}_valid"
                                ...
                                <div class="fieldRow clearfix">
                                    <div class="row">
                                                ...
                                                <div class="controls disciplines_level">
													...
													<input type='checkbox' name='record' style="display:none;">
                                                        <select name="disciplines_level[{{'2'}}]"
                                                                ...
                                                                class="length form-control types">
															<option value="">Select Type</option>
                                                            @foreach($disciplines as  $discipline)
                                        ...
                                        <div class="col-md-2">
                                            <div id="div_organization_registration"
                                                 class="form-group certificates_valid">
                                                <label for="certificates_1_valid"
                                                       class="control-label  requiredField">
                                                    Valid Untill<span
                                                            class="asteriskField">*</span>
                                                </label>
                                                <div data-date-format="yyyy-mm-dd" class="input-group certificates_valid date date_error" data-provide="datepicker">
                                                    <input type="text" readonly aria-invalid="false"
                                                           name="certificates_valid[{{'2'}}]"
                                                           id="certificates_1_valid"
                                                           class="textinput form-control length"/>
														   <div class="input-group-addon">
													<span class="glyphicon glyphicon-th"><i class="far fa-calendar-alt"></i></span>
													</div>
			...
			<div class="row">
				<div class="col-md-12 col-sm-12" id="choose_option">
					<div class="form-group">
						...
						<div class="radio">
							<label>
								<input {{ $usersMeta->tutor_profile->work_permit_option == '0' ?  'checked' : '' }} type="radio" id="rtowork1" name="rtowork" class="rtowork" value="0">Passport 
							</label> <label>
								<input {{ $usersMeta->tutor_profile->work_permit_option == '1' ?  'checked' : '' }} type="radio" id="rtowork2" name="rtowork" class="rtowork" value="1">Work Permit 
							</label>
							<label>
								<input {{ $usersMeta->tutor_profile->work_permit_option == '2' ?  'checked' : '' }} type="radio" id="rtowork3" name="rtowork" class="rtowork" value="2">Home Office Doc, or I.D/Citzenship Card
							</label> <label>
								<input {{ $usersMeta->tutor_profile->work_permit_option == '3' ?  'checked' : '' }} type="radio" id="rtowork4" name="rtowork" class="rtowork" value="3">Birth Certificate
							</label>
							</div>
					</div>
				</div>
    ...
    <div class="row" id="passport" style="{{ $usersMeta->tutor_profile->work_permit_option == '0' ?  '' : 'display:none' }}">
        <div class="col-md-12">
            <div class="well third-well">
				...
				<div class="row">
					...
					<div class="form-group">
					   ...
					   <input name="indifinite_st" {{ $usersMeta->tutor_profile->indifinite_st == '1' ?  'checked' : '' }} id="indifinite_st" value="1" onchange="manage_expiry(this)" type="checkbox">Indifinite Stay</label>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3" id="expiry_div" style="{{ $usersMeta->tutor_profile->indifinite_st == '1' ?  'display:none' : '' }}">
                        <label for="pass_expiry_date"
                               class="control-label">
                            Expiry Date: <span class="asteriskField">*</span>
                        </label>
                        <div data-date-format="dd-mm-yyyy"
                             class="input-group date date_error permitEndDates"
                             data-provide="datepicker">
					...
					<div class="form-group">
                        ...
                        <input type="number" value="{{$usersMeta->tutor_profile->passport_no}}"
                               name="passport_no"
                               id="passport_no"
                               class="form-control"/>
                    </div>
    ...
    <div class="row" id="work_permit" style="{{ $usersMeta->tutor_profile->work_permit_option == '1' ?  '' : 'display:none;' }}">
        <div class="col-md-12">
            <div class="well fourth-well">
			<h2 class="credentials_form_title">Work Permit</h2>
				<div class="row">
					...
					<div class="form-group">
					   ...
					   <input name="indifinite_workperm" {{ $usersMeta->tutor_profile->indifinite_workperm == '1' ?  'checked' : '' }} id="indifinite_workperm" value="1" onchange="manage_expiry_permit(this)" type="checkbox">Indifinite Stay</label>
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div data-date-format="dd-mm-yyyy"
                             class="input-group date date_error permitStartDates"
                             data-provide="datepicker">
                            <input readonly type="text" class="form-control valid"
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" value="{{$usersMeta->tutor_profile->permit_no}}"
                               name="permit_no"
                               id="permit_no"
                               class="form-control"/>
                    </div>
	 ...
	 <div class="row" id="birth_certificate" style="{{ $usersMeta->tutor_profile->work_permit_option == '3' ?  '' : 'display:none' }}">
        <div class="col-md-12">
            <div class="well fourth-well">
		        <div class="row">
     <div class="col-md-6 col-sm-6">
   ...
   <div class="row" id="home_office_doc" style="{{ $usersMeta->tutor_profile->work_permit_option == '2' ?  '' : 'display:none' }}">
        <div class="col-md-12">
            <div class="well fourth-well">
		        <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
					   ...
					   <input name="indifinite_homedoc" {{ $usersMeta->tutor_profile->indifinite_homedoc == '1' ?  'checked' : '' }} id="indifinite_homedoc" value="1" type="checkbox">Indifinite Stay</label>
			 ...
			 <h2 class="credentials_form_title">Bank Account Details</h2>
                <div class="row">
					...
					<div class="form-group">
                        ...
                        <input type="text" value="{{$usersMeta->tutor_profile->bank}}"
                               name="bank"
                               id="bank"
                               class="form-control"/>
                    </div>
                    ...
                    <div class="col-md-4">
					<div class="form-group">
                        <label for="account_fname"
                               class="control-label">
                            Account Holder's Name: <span class="asteriskField">*</span>
                        </label>
                        <input type="text" value="{{$usersMeta->tutor_profile->account_fname}}"
                               name="account_fname" placeholder="Name appears on bank docs" id="account_fname" class="form-control"/>
                    </div>
                    </div>
                   <!-- <div class="col-md-4">
					...
					<div class="form-group">
                        ...
                        <input type="number" value="{{$usersMeta->tutor_profile->account_no}}"
                               name="account_no"
                               id="account_no"
                               class="form-control"/>
                    </div>
					...
					<div class="form-group">
                        ...
                        <input type="number" value="{{$usersMeta->tutor_profile->bank_code}}"
                               name="bank_code"
                               id="bank_code"
                               class="form-control"/>
                    </div>
...
<div class="row">
	<div class="col-md-6 col-sm-6">
		<div class="form-group ">
			...
			<input class="form-control" id="ref1_company_name"
				   value="{{$usersMeta->tutor_profile->ref1_company_name}}"
				   name="ref1_company_name" type="text"/>
	...
	<div class="col-md-6 col-sm-6">
		<div class="form-group ">
			...
			<input class="form-control" id="ref1_name"
				   value="{{$usersMeta->tutor_profile->ref1_name}}"
...
<div class="col-md-6 col-sm-6">
	<div class="form-group ">
		...
		<input class="form-control" id="ref1_contact_tel"
			   value="{{$usersMeta->tutor_profile->ref1_contact_tel}}"
			   name="ref1_contact_tel" type="text"/>
...
<div class="col-md-6 col-sm-6">
	<div class="form-group ">
		...
		<input class="form-control" id="ref1_email"
			   value="{{$usersMeta->tutor_profile->ref1_email}}"
...
<div class="row">
	<div class="col-md-6 col-sm-6">
		<div class="form-group ">
			...
			<input class="form-control" id="ref2_company_name"
				   value="{{$usersMeta->tutor_profile->ref2_company_name}}"
				   name="ref2_company_name" type="text"/>
	...
	<div class="col-md-6 col-sm-6">
		<div class="form-group ">
			...
			<input class="form-control" id="ref2_name"
				   value="{{$usersMeta->tutor_profile->ref2_name}}"
...
<div class="col-md-6 col-sm-6">
	<div class="form-group ">
		...
		<input class="form-control" id="ref2_contact_tel"
			   value="{{$usersMeta->tutor_profile->ref2_contact_tel}}"
			   name="ref2_contact_tel" type="text"/>
...
<div class="col-md-6 col-sm-6">
	<div class="form-group ">
		...
		<input class="form-control" id="ref2_email"
			   value="{{$usersMeta->tutor_profile->ref2_email}}"
			...
			<h2 class="credentials_form_title">Upload Documents</h2>
                    ...
                    <div class="col-md-6 col-sm-6">
						...
						<div class="tooltip_custom">
                            <label class="control-label" for="certificates_upload">
								...
								<i class="color-info fa fa-question-circle"></i>
								<span class="tooltiptext">Please attach all certificates ralated to Certifications section on top of this page.</span>
                            </label>
							</div>
				...
				<div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <input name="professionalbodies_upload[]" id="professionalbodies_upload"
                                   type="file" multiple="multiple">
								   @if(isset($usersMeta->teaching_certificates))
								   @foreach($usersMeta->teaching_certificates as $certificates)
...
<div class="modal fade maiilModal" style="top:32%;z-index:9999999" id="dbs_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-wrap">
						...
						<a href="https://secure.crbonline.gov.uk/crsc/apply?execution=e3s1" target="_blank">https://secure.crbonline.gov.uk/crsc/apply?execution=e3s1</a>
                    </div>
                </div>
...
<div class="modal fade maiilModal" style="top:32%;z-index:9999999" id="dbs_cert_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="text-wrap">
                    	<p id="comment">Please click on below link for the DBS registration:</p><a href="http://www.personnelchecks.co.uk/freelance-genie" target="_blank">http://www.personnelchecks.co.uk/freelance-genie</a></p>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
/*$('#msform #step1Next').click(function(){
  ...
  $('.rtowork').click(function(){
    ...
    $('#home_office_doc').hide()
 	...
 	$('#certificates_div').on('change','.types',function(){//certificates_div is the outer div in which all dynamic content is added
    //alert('ok');
	var id=$(this).val();
//const selectMembers = $("#specialist");
  //  selectMembers.empty();
$('input[name="record"]').prop('checked', false);
$(this).closest('#certificates_div .types_div').find('input[name="record"]').prop('checked', true);
			$("#certificates_div").find('input[name="record"]').each(function(i){
                ...
                data: {
                    get_option: id,page:'tutor_profile',index_num:number,
                    "_token": "{{ csrf_token() }}"
                },
                ...
                //$('#sp').html(response);
                $('#certificates_'+number+'_categorie').multiselect({
