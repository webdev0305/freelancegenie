            ...
            <div class="col-md-12">
                ...
                <div class="kamkaaj-jobdetail-list">
					...
					$current_date=strtotime($current_date);?>
                        ...
                        <button type="button" class="announce kamkaaj-jobdetail-list-btn" data-id="{{encrypt($jobs->id)}}"  data-status="8"  data-toggle="modal" data-target="#deleteMerchant">Accept
                        </button>
						@endif
