        ...
        <div class="row no-gutters">
            ...
            <div class="col-md-6 employees data-aos=" fade-left>
                <div class="tooltip_custom">
                    ...
                    <div class="text-wrap">
                        <p><i class="fas fa-angle-right"></i> Choose the appropriate plan and gain access to the Best FL
                            talent </p>
            ...
            <div class="col-md-6">
                <div class="inner_box">
                    ...
                    <div class="content">
                        ...
                        <p>The Freelance Genie platform is one of the most exciting opportunities for freelance
                            trainers. As a freelance tutor or Subcontractor, you can easily sign up through our free
                            online registration where you will have access to a simple online facility used to find
                            assignments and manage each of your bookings.</p>
                        <p> Across the platform, you will have access to a wide variety of live assignments and can
                            maximise your earning potential by accepting and rejecting freelance tutor jobs online. The
                            entire service is completely flexible, helping you to maintain a healthy work-life balance
                            and manage your own workflow - with all mileage and expenses covered. Through our simple
                            onboarding process, you can start your job search immediately and have the ability to
                            subsidise your income, maximising your time through providing course tuition, working as and
                            when you want. </p>
                        <a href="{{url('how_it_works')}}">Read More</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="inner_box employer_work">
                    ...
                    <div class="content">
                        ...
                        <p>With our 24/7 access online platform, you can easily find Independent freelance tutors,
                            trainers and subcontractors online who have each been fully vetted and verified - giving you
                            complete peace of mind with regular DBS updates.</p>
                        <p> We offer simple subscription options which allow you to post live assignments that can be
                            auto accepted by trainers, with accurate and transparent pricing structures for all
                            bookings. Detailed in our terms, our dedicated team pay and manage all tutor costs, covering
                            any absences and sickness - guaranteeing the arrival of your tutor, keeping to your agreed
                            schedule and avoiding changes. Our entire service is quick and easy, as well as fully
                            compliant. You will no longer have to worry about interviewing individual candidates and
                            cancelling courses, as everything will be managed by us. </p>
                        <a href="{{url('how_it_works')}}">Read More</a>
                    </div>
                </div>
            </div>
...
<div class="modal maiilModal" id="form_validation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
