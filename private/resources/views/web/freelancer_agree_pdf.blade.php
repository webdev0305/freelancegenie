...
<head>
    ...
    <title>Freelancer Agreement - Tutorsandtrainersonline</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="">
    <meta name="keyword" content="">

    <link rel="shortcut icon" href="https://localhost/freelancegenie/web/images/favicon.png" type="image/x-icon" />

    <link rel="stylesheet" href="https://localhost/freelancegenie/assets/web/stylesheets/styles.css" />
