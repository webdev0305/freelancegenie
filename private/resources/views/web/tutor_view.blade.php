									...
									<div class="col-md-4">
										<div class="text-wrap listing">
											<p>
												...
												<span>{{date('d/m/Y',strtotime($usersMeta->tutor_profile->permit_start_date))}}</span></p>
										</div>
									</div>
									<div class="col-md-4">
										<div class="text-wrap listing">
											<p>
												...
												<span>{{date('d/m/Y',strtotime($usersMeta->tutor_profile->permit_expiry_date))}}</span></p>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="col-md-12">
										<div class="text-wrap listing">
											<p>
												...
												<span class="">{{date('d/m/Y',strtotime($usersMeta->tutor_profile->cert_issued))}}</span></p>
										</div>
									</div>
...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-lg">
		...
		<input class="form-control" id="distance_value" name="distance_value" value="" type="hidden"/>
					...
					<fieldset>
									...
									<div class="col-md-12">
										<div class="form-group ">
											...
											<input class="form-control" id="title"
												   name="title" readonly value="@foreach($categories as $category){{$category->name.', '}}@endforeach" type="text"/>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group ">
										   ...
										   <input class="form-control" id="title"
												   name="duration" readonly value="@foreach($categories as $category){{$category->duration.' hours, '}}@endforeach" type="text"/>
								...
								<div class="row">
									<div class="col-md-6 col-sm-6">
										<div class="form-group">
											...
											<div class="radio">
												<label>
													<input type="radio" checked name="mileage" id="mileage"
														   value="0">No
												</label> 
												<label>
													<input type="radio" name="mileage" id="mileage"
														   value="1">Yes
												</label>
											</div>
										</div>
									...
									<div class="col-md-6 col-sm-6">
										<div class="form-group">
											...
											<div class="radio">
												...
												<label>
													<input type="radio" name="hotel_cost" id="hotel_cost"
														   value="1">Yes
												</label>
											</div>
										</div>
								...
								<div class="row">
									<div class="col-md-12">
										...
										<label for="usr"><input type="radio"  data-tutor_id='{{$usersMeta->id}}' required name="booking_address" value="0" id="usr">Company Address</label>
											
											<label for="na"><input type="radio" data-tutor_id='{{$usersMeta->id}}' required name="booking_address" value="1" id="na">Delivery Address</label><br>
											<span class="glyphicon glyphicon-user form-control-feedback"></span>
											<span class="text-danger">
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<label class="control-label " for="time_start">
											...
											<input type="time" id="time_start" name="time_start" min="06:00" max="18:00" required>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group ">
											...
											<select required class="form-control" id="qualified_levels" name="qualified_levels">
												@if(!empty(\Input::get('level')))
													@foreach($usersMeta->qualified_level as  $level)
													 ...
													 <option value="{{$level->id}}">{{isset($level->name)?$level->name:''}}</option> 
													 @endif
													@endforeach
												@endif
											</select>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group radio">
											...
											<label for="usr"><input data-tutor_id='{{$usersMeta->id}}' type="radio"  required name="booking_address" value="0" id="usr">Company Address</label>
											
											<label for="na"><input data-tutor_id='{{$usersMeta->id}}' type="radio" required name="booking_address" value="1" id="na">Delivery Address</label><br>
											<span class="glyphicon glyphicon-user form-control-feedback"></span>
											<span class="text-danger">
											<span id="booking_address-error"></span>
											</span>
					...
					<input type="hidden" value="@if(!empty(\Input::get('cat_id'))){{$care_cost}}@endif" name="total" id="total">
					<div class="row">
					...
					<div class="">
    					<label class="checkbox">
							<input required="" class="" name="fifty" type="checkbox" id="fifty"><span>I agree to 30days invoice terms</span>
						</label>
					</div>
					@else
						...
						<div class="col-md-4 col-lg-4 col-sm-4">
							<div class="pymnt_optns">
								<div class="pymnt_optns1 cs_py">
									...
									<div class="cstm-bc-cntr">
										<label class="radio">
										<input type="radio" name="py_slct" value="CREDIT CARD" class="chk_py" checked="">CREDIT CARD</label>
									</div>
								</div>
							</div>
						</div>
							<div class="col-md-4 col-lg-4 col-sm-4">
								<div class="pymnt_optns2 cs_py">
									...
									<div class="cstm-bc-cntr">
										<label class="radio">
										<input type="radio" name="py_slct" value="BANK TRANSFER" class="chk_py">BANK TRANSFER</label>
									</div>
								</div>
							</div>
							<div class="col-md-4 col-lg-4 col-sm-4">
								<div class="pymnt_optns3 cs_py">
									...
									<div class="cstm-bc-cntr">
										<label class="radio">
										<input type="radio" name="py_slct" value="INVOICING" class="chk_py">INVOICING</label>
									</div>
								</div>
							</div>
							<span class="glyphicon glyphicon-user form-control-feedback"></span>
       ...
       // var tutor_id=$(this).data('tutor_id');
            $.ajax({
				...
				//var response=$.parseJSON(data);
                  ...
                  //alert (data);
                    if(parseInt(data)){
						getLevels({{\Input::get('specialist')[0]}});
		...
		function priceAjax() {
					...
					var travel_cost_hot_booking=2*booking_days*hot_booking_dist*0.30;
						...
						$('#additional_cost').html('Hotel Cost: £'+hotel_cost.toFixed(2)+' <br>Travel Cost from Tutor Venue to Hotel: £'+travel_cost.toFixed(2)+' <br>Travel Cost from Hotel to Booking Address: £'+travel_cost_hot_booking.toFixed(2));
					}else{
						//alert('cond4');
						var travel_cost=2*booking_days*parseInt(distance_text)*0.30;
						$('#additional_cost').html('Travel Cost from Tutor Venue to Booking Venue: £'+travel_cost.toFixed(2));
