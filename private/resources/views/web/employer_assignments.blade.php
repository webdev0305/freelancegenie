        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post"  enctype="multipart/form-data" id="insert_form">
					...
					<div id="step0" class="stepDetails"><fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <div class="form-group ">
                                ...
                                <input class="form-control" name="rate" type="number" min="0" max="10000" id="rate">
					...
					<div class="row">
                        ...
                        <div class="col-md-12">
							...
							<label class="control-label " for="type_levels">
                                    Select type of tutor matched with your assignment<span class="asteriskField">*</span>
                                </label>
					...
					<div class="col-md-12">
							...
							<label class="control-label">
								Where do you want your booking to take place?<span class="asteriskField">*</span>
							</label>
					</div>
							<div class="col-md-6 col-sm-6">	
							<div class="form-group">							
								<div class="radio">
								<label for="usr">
									<input checked type="radio" name="booking_address" value="0" id="usr">Your Company Address
								</label> 
								</div>
							</div>
							</div>
							...
							<div class="radio">
								<label for="na">
									<input type="radio" name="booking_address" value="1" id="na">Enter your own Delivery Address
								</label>
							</div>
							</div>
							</div>
		...
		<!--<div class="col-md-6">
                    ...
                    <div class="col-md-6">
                            <div class="form-group ">
                                ...
                                <input class="form-control" id="awarding"
                                       name="awarding" type="text"/>
                                <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                <span class="text-danger">
                        ...
                        <div class="col-md-6">
                            <div class="form-group ">
                                ...
                                <input type="file" class="form-control" multiple="multiple" id="file" name="photos[]">
                                <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                <span class="text-danger">
					...
					<label class="checkbox"><input type="checkbox" name="premium" id="premium" onchange="activateButton(this)"> Post as a premium</label>
                 ...
                 <div class="col-md-6">
					...
					<div id="step1" class="stepDetails" style="display: none;"><fieldset>
                    ...
                    <label class="checkbox"><input type="checkbox" name="" id="">I agree <a href="{{url('terms')}}">terms & conditions</label>
                    <input type="button" id="insert" class="btn btn-success" name="assignment_sub" value="submit">
                    </fieldset>
					</div>
                </form>
            </div>
...
@push('scripts')
 <script src="{{ asset('js/admin/formtowizard.js') }}" type="text/javascript"></script>
   ...
   <script src="{{ asset('js/admin/jquery-ui.multidatespicker.js') }}"
				...
				//var response=$.parseJSON(data);
                  ...
                  //alert (data);
                    if(parseInt(data)){
                        ...
                        alert('You have posted all assignments included in your subscription.Please renew your subscription plan to post more.');
                        }
                }
 ...
 function load_data(limit, start)
 {
  $.ajax({
   ...
   var link='{{url("employer/detail_assignment")}}/'+obj[key]['id'];
   var logo='';
