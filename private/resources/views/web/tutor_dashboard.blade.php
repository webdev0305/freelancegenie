            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{-- $status --}}
                        ...
                        <button type="button" class="update_register_btn btn btn-success float-left mr-1" data-id="{{$job['userjobs']->id}}"  data-status="2"  data-toggle="modal" data-target="#update_register">
                            Update Register
                        </button>
                        @endif
