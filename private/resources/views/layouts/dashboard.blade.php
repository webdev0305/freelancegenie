...
<style>
  ...
  right: 0;
  bottom: 0;
  background-image: url('web/images/site_underconstruction.png'); /* Black background with opacity */
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    <ul class="navbar-nav justify-content-end w-100">
                        <li class="nav-item {{ (Request::is('*dashboard') ? 'active' : '') }}"><a class="nav-link" href="{{url('/')}}">Home</a></li>
                        <li class="nav-item {{ (Request::is('*about') ? 'active' : '') }}"><a class="nav-link" href="{{url('about')}}">About Us</a></li>
                        
                        <li class="nav-item {{ (Request::is('courses') ? 'active' : '') }}"><a class="nav-link" href="{{url('courses')}}">Courses</a></li>
			<li class="nav-item {{ (Request::is('care_courses') ? 'active' : '') }}"><a class="nav-link tooltip_custom" href="{{url('care_courses')}}">CQC Care Courses<i class="fas fa-heart heart-icon"></i> <div class="tooltiptext">Suitable For All Staff And All Industries</div></a></li>
                ...
                <div class="right-section d-none d-lg-block">
                    <ul class="">
                            ...
                            <li class="{{($user->inRole('tutor'))?'tutor':'employer'}} dropdown">
                                ...
                                <div class="dropdown-menu">
                                        ...
                                        @if ($user->inRole('tutor'))
											...
											<a class="dropdown-item" target="_blank" href="https://secure.crbonline.gov.uk/crsc/subscriber">Update DBS</a>
                        ...
                        <!--<li class="tutor dropdown">
                            ...
                            <li class="tutor dropdown">
                                <a class=" tooltip_custom" href="#" id="navbardrop" data-toggle="dropdown"><span>For Tutor</span> <div class="tooltiptext">Are you tutor? Sign up for free here.</div></a>
                                <div class="dropdown-menu">
                            ...
                            <li class="employer dropdown">
                                <a class=" tooltip_custom" href="#" id="navbardrop"
                                   data-toggle="dropdown"><span>For Employer</span> <div class="tooltiptext">Do you need access to freelance tutors & Trainers. <br>Join Here</div></a>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{url('login')}}">Login</a>
